...
export function Tooltip({ text }: TooltipProps) {
  ...
  return (
    <span className="relative inline-block ml-1">
      ...
      {isVisible && (
        <div className="absolute z-50 bottom-full left-0 mb-2 px-3 py-2 text-sm text-white bg-gray-800 rounded-lg shadow-lg w-[360px] whitespace-pre-line leading-relaxed">
          {text}
